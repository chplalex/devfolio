                ...
                widget.projectIcon != null
                    ? (width > 1135 || width < 950)
                        ...
                        : Row(
                            ...
                            children: [
                              Image.asset(widget.projectIcon!, height: height * 0.03),
                              SizedBox(width: width * 0.01),
                              Text(widget.projectTitle, style: AppText.b2b, textAlign: TextAlign.center),
                            ],
                          )
                    : Container(),
                widget.projectIconData != null
                    ? Icon(widget.projectIconData, color: AppTheme.c!.primary!, size: height * 0.1)
                    : Container(),
                (width > 1135 || width < 950) ? SizedBox(height: height * 0.02) : const SizedBox(),
                (width > 1135 || width < 950)
                    ? Text(widget.projectTitle, style: AppText.b2b, textAlign: TextAlign.center)
                    : const SizedBox.shrink(),
                SizedBox(height: height * 0.01),
                Text(widget.projectDescription, textAlign: TextAlign.center),
                SizedBox(height: height * 0.01),
              ],
            ),
            AnimatedOpacity(
